...
const BLOG = {
  AUTHOR: '天使笑', // 作者
  BIO: '天使笑’S blog', // 作者简介
  LINK: 'https://yike6.com', // 网站地址
  AVATAR: '/avatar.png', // 个人头像 默认取public目录下的avatar.png
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || 'f1adf8fb6d754f98aee597be1bd23bfd', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'wq.g@live.cn',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/gwq315,
  CONTACT_TELEGRAM: '',
